---
title: "Comércio Internacional, Disponibilidade Interna e Inflação de Alimentos no Brasil, de 2007 a 2021"
...
COMEX_EXP_97_22_V1 <- read_delim(
   c("~/R program/_IAIABr-main/_Artigo_Internacional/Script/DATA_BASE/EXP_1997_2009_20220403.csv",
     "~/R program/_IAIABr-main/_Artigo_Internacional/Script/DATA_BASE/EXP_2010_2022_20220403.csv"),
   delim = ";",
...
COMEX_IMP_97_22_V1 <- read_delim(
   c("~/R program/_IAIABr-main/_Artigo_Internacional/Script/DATA_BASE/IMP_1997_2009_20220403.csv",
     "~/R program/_IAIABr-main/_Artigo_Internacional/Script/DATA_BASE/IMP_2010_2022_20220403.csv"),
   delim = ";",
   escape_double = FALSE, trim_ws = TRUE)
```
...
write_rds(COMEX_EXP_IMP_97_22, "~/R program/_IAIABr-main/_Artigo_Internacional/Script/DATA_BASE/Raw/COMEX_EXP_IMP_97_22.rds")
...
```{r}
COMEX_EXP_IMP_97_22 <- read_rds("~/R program/_IAIABr-main/_Artigo_Internacional/Script/DATA_BASE/Raw/COMEX_EXP_IMP_97_22.rds")
...
write_rds(COMEX_97_22, "~/R program/_IAIABr-main/_Artigo_Internacional/Script/DATA_BASE/Raw/COMEX_97_22.rds")
...
DICIO_AGROSTAT <- read_excel("~/R program/_IAIABr-main/_Artigo_Internacional/Script/DATA_BASE/DICIO_AGROSTAT.xlsx")
...
write_rds(DICIO_AGROSTAT_COMP, "~/R program/_IAIABr-main/_Artigo_Internacional/Script/DATA_BASE/Raw/DICIO_AGROSTAT_COMP.rds")
...
DICIO_AGROSTAT_COMP <- read_rds("~/R program/_IAIABr-main/_Artigo_Internacional/Script/DATA_BASE/Raw/DICIO_AGROSTAT_COMP.rds")

# Carregando o banco de dados COMEX
COMEX_97_22 <- read_rds("~/R program/_IAIABr-main/_Artigo_Internacional/Script/DATA_BASE/Raw/COMEX_97_22.rds")
...
write_rds(COMEX_97_22_COMP, "~/R program/_IAIABr-main/_Artigo_Internacional/Script/DATA_BASE/Raw/COMEX_97_22_COMP.rds")
...
COMEX_97_22_COMP <- read_rds("~/R program/_IAIABr-main/_Artigo_Internacional/Script/DATA_BASE/Raw/COMEX_97_22_COMP.rds")

# Seleção dos produtos agropecuários
## Açúcar
zsucroalcool <- COMEX_97_22_COMP %>%
   filter(ANO %in% 2007:2021,
...
zcacau <- COMEX_97_22_COMP %>% 
   filter(ANO %in% 2007:2021,
          CATEG == "Cacau e seus produtos") %>% 
   select(!c(QTD_EST, VAL_DOLAR)) %>%
   mutate(PA = "Cacau")
...
COMEX_EXP_IMP <- rbind(zarroz, zbanana, zbatata, zcacau, zcafe, zcebola, zfeijao, zlaranja, zmandioca, zmilho, zsoja, ztomate, ztrigo1, ztrigo2, zsucroalcool, zleite, zovo, zbovino, zsuino, zfrango) %>%
   mutate(QTD_LIQ = (KG_LIQ/1000000000),
          UNID = "Milhões de toneladas", .keep = "unused")

# Salvando base de dados dos produtos agrícolas
write_rds(COMEX_EXP_IMP, "~/R program/_IAIABr-main/_Artigo_Internacional/Script/DATA_BASE/Raw/COMEX_EXP_IMP.rds")

rm(zarroz, zbanana, zbatata, zcafe, zcebola, zfeijao, zlaranja, zmandioca, zmilho, zsoja, ztomate, ztrigo1, ztrigo2, zsucroalcool, zleite, zovo, zbovino, zsuino, zfrango, zcacau, COMEX_97_22_COMP)
```
...
COMEX_EXP_IMP <- read_rds("~/R program/_IAIABr-main/_Artigo_Internacional/Script/DATA_BASE/Raw/COMEX_EXP_IMP.rds")

# Carregando dicionário para filtrar NCMs a serem utilizados no trabalho
DICIO_NCM_PRIMARIOS <- read_xlsx("~/R program/_IAIABr-main/_Artigo_Internacional/Script/DATA_BASE/DICIO_NCM_PRIMARIOS.xlsx")
...
write_rds(COMEX_EXP_IMP_PRIM, "~/R program/_IAIABr-main/_Artigo_Internacional/Script/DATA_BASE/Raw/COMEX_EXP_IMP_PRIM.rds")
...
# path = "~/R program/_Artigo_Internacional/Script/DATA_BASE/Raw/CanaSerieHistZ-ZIndustria.xls"
```
...
```{r}
PROD_LEITE <- read_excel("~/R program/_IAIABr-main/_Artigo_Internacional/Script/DATA_BASE/PROD_PEC.xlsx", sheet = "Leite")
```
...
```{r}
PROD_OVO <- read_excel("~/R program/_IAIABr-main/_Artigo_Internacional/Script/DATA_BASE/PROD_PEC.xlsx", sheet = "Ovos")
...
knitr::kable(PROD_OVO_LEITE)

rm(PROD_LEITE_CALC, PROD_OVO_CALC, PROD_OVO_LEITE)
```
...
```{r}
PROD <- read_excel("~/R program/_IAIABr-main/_Artigo_Internacional/Script/DATA_BASE/PRODUCAO.xlsx")
```

```{r}
# Organizando a produção final - valores em milhões de toneladas
PROD_V1 <- PROD %>% 
   filter(ANO %in% c(2007:2021)) %>% 
...
COMEX_EXP_IMP_PRIM <- read_rds("~/R program/_IAIABr-main/_Artigo_Internacional/Script/DATA_BASE/Raw/COMEX_EXP_IMP_PRIM.rds")

LARANJA <- COMEX_EXP_IMP_PRIM %>% 
   filter(PA == "Laranja")

# Importando o índice de conversão da laranja
IND_CONV_LARANJA <- read_xlsx("~/R program/_IAIABr-main/_Artigo_Internacional/Script/DATA_BASE/INDICE_CONVERC_LARANJA.xlsx",
                              sheet = "Indexador") %>% 
...
IND_CONV_OVO <- read_xlsx("~/R program/_IAIABr-main/_Artigo_Internacional/Script/DATA_BASE/INDICE_CONVERC_OVO_LEITE.xlsx",
                              sheet = "OVO")
...
IND_CONV_LEITE <- read_xlsx("~/R program/_IAIABr-main/_Artigo_Internacional/Script/DATA_BASE/INDICE_CONVERC_OVO_LEITE.xlsx",
                              sheet = "LEITE")
...
write_rds(COMEX_EXP_IMP_PRIM_FINAL, "~/R program/_IAIABr-main/_Artigo_Internacional/Script/DATA_BASE/Raw/COMEX_EXP_IMP_PRIM_FINAL.rds")
...
```{r}
COMEX_EXP_IMP_PRIM_FINAL <- read_rds("~/R program/_IAIABr-main/_Artigo_Internacional/Script/DATA_BASE/Raw/COMEX_EXP_IMP_PRIM_FINAL.rds")
...
write_xlsx(COMEX_GERAL, "~/R program/_IAIABr-main/_Artigo_Internacional/Planilhas/_COMEX_AGRIC_GERAL.xlsx")
...
write_xlsx(COMEX_AGROPEC_FINAL, "~/R program/_IAIABr-main/_Artigo_Internacional/Planilhas/_COMEX_AGRIC_CALC.xlsx")

write_rds(COMEX_AGROPEC_FINAL, "~/R program/_IAIABr-main/_Artigo_Internacional/Script/DATA_BASE/Raw/COMEX_AGROPEC_FINAL.rds")
