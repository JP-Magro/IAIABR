...
write_rds(IPCA_99_06_BR_VarMes, "../coleta/data-raw/IPCARaw/IPCA_1k99_2K06_VarMes_BRASIL_BRUTO.rds", compress = "gz")

IPCA_99_06_BR_VarAcu <- COLETA(PERIOD1, 657, V = c(69), GE = c("Brazil"))
write_rds(IPCA_99_06_BR_VarAcu, "../coleta/data-raw/IPCARaw/IPCA_1k99_2K06_VarAcu_BRASIL_BRUTO.rds", compress = "gz")

IPCA_99_06_BR_Peso <- COLETA(PERIOD1, 656, V = c(66), GE = c("Brazil"))
write_rds(IPCA_99_06_BR_Peso, "../coleta/data-raw/IPCARaw/IPCA_1k99_2K06_Peso_BRASIL_BRUTO.rds", compress = "gz")
```
...
write_rds(IPCA_99_06_CIDA_VarMes, "../coleta/data-raw/IPCARaw/IPCA_1k99_2K06_VarMes_CIDADE_BRUTO.rds", compress = "gz")

IPCA_99_06_CIDA_VarAcu <- COLETA(PERIOD1, 657, V = c(69), GE = c("City"))
write_rds(IPCA_99_06_CIDA_VarAcu, "../coleta/data-raw/IPCARaw/IPCA_1k99_2K06_VarAcu_CIDADE_BRUTO.rds", compress = "gz")

IPCA_99_06_CIDA_Peso <- COLETA(PERIOD1, 656, V = c(66), GE = c("City"))
write_rds(IPCA_99_06_CIDA_Peso, "../coleta/data-raw/IPCARaw/IPCA_1k99_2K06_Peso_CIDADE_BRUTO.rds", compress = "gz")
```
...
write_rds(IPCA_99_06_METRO_VarMes, "../coleta/data-raw/IPCARaw/IPCA_1k99_2K06_VarMes_METRO_BRUTO.rds", compress = "gz")

IPCA_99_06_METRO_VarAcu <- COLETA(PERIOD1, 657, V = c(69), GE = c("MetroRegion"))
write_rds(IPCA_99_06_METRO_VarAcu, "../coleta/data-raw/IPCARaw/IPCA_1k99_2K06_VarAcu_METRO_BRUTO.rds", compress = "gz")

IPCA_99_06_METRO_Peso <- COLETA(PERIOD1, 656, V = c(66), GE = c("MetroRegion"))
write_rds(IPCA_99_06_METRO_Peso, "../coleta/data-raw/IPCARaw/IPCA_1k99_2K06_Peso_METRO_BRUTO.rds", compress = "gz")
```
...
IPCA_99_06_BR_VarMes <- readRDS("../coleta/data-raw/IPCARaw/IPCA_1k99_2K06_VarMes_BRASIL_BRUTO.rds")
IPCA_99_06_BR_VarAcu <- readRDS("../coleta/data-raw/IPCARaw/IPCA_1k99_2K06_VarAcu_BRASIL_BRUTO.rds")
IPCA_99_06_BR_Peso <- readRDS("../coleta/data-raw/IPCARaw/IPCA_1k99_2K06_Peso_BRASIL_BRUTO.rds")

IPCA_99_06_CIDA_VarMes <- readRDS("../coleta/data-raw/IPCARaw/IPCA_1k99_2K06_VarMes_CIDADE_BRUTO.rds")
IPCA_99_06_CIDA_VarAcu <- readRDS("../coleta/data-raw/IPCARaw/IPCA_1k99_2K06_VarAcu_CIDADE_BRUTO.rds")
IPCA_99_06_CIDA_Peso <- readRDS("../coleta/data-raw/IPCARaw/IPCA_1k99_2K06_Peso_CIDADE_BRUTO.rds")

IPCA_99_06_METRO_VarMes <- readRDS("../coleta/data-raw/IPCARaw/IPCA_1k99_2K06_VarMes_METRO_BRUTO.rds")
IPCA_99_06_METRO_VarAcu <- readRDS("../coleta/data-raw/IPCARaw/IPCA_1k99_2K06_VarAcu_METRO_BRUTO.rds")
IPCA_99_06_METRO_Peso <- readRDS("../coleta/data-raw/IPCARaw/IPCA_1k99_2K06_Peso_METRO_BRUTO.rds")
...
#Salvando----
write_rds(IPCA_1k99_2k06_DATA, "../coleta/data-raw/IPCARaw/IPCA_1k99_2k06_DATA_FINAL.rds", compress = "gz")
...
write_rds(IPCA_06_11_BR, "../coleta/data-raw/IPCARaw/IPCA_2K06_2K11_BRASIL_BRUTO.rds", compress = "gz")
```
...
write_rds(IPCA_06_11_CIDA, "../coleta/data-raw/IPCARaw/IPCA_2K06_2K11_CIDADE_BRUTO.rds", compress = "gz")
```
...
write_rds(IPCA_06_11_METRO, "../coleta/data-raw/IPCARaw/IPCA_2K06_2K11_METRO_BRUTO.rds", compress = "gz")
```
...
IPCA_06_11_BR <- readRDS("../coleta/data-raw/IPCARaw/IPCA_2K06_2K11_BRASIL_BRUTO.rds")
IPCA_06_11_CIDA <- readRDS("../coleta/data-raw/IPCARaw/IPCA_2K06_2K11_CIDADE_BRUTO.rds")
IPCA_06_11_METRO <- readRDS("../coleta/data-raw/IPCARaw/IPCA_2K06_2K11_METRO_BRUTO.rds")
...
write_rds(IPCA_2k6_2k11_DATA, "../coleta/data-raw/IPCARaw/IPCA_2k6_2k11_DATA_FINAL.rds", compress = "gz")
...
write_rds(IPCA_12_19_BR, "../coleta/data-raw/IPCARaw/IPCA_2K12_2K19_BR_BRUTO.rds", compress = "gz")
```
...
write_rds(IPCA_12_19_CIDA, "../coleta/data-raw/IPCARaw/IPCA_2K12_2K19_CIDADE_BRUTO.rds", compress = "gz")
```
...
write_rds(IPCA_12_19_METRO, "../coleta/data-raw/IPCARaw/IPCA_2K12_2K19_METRO_BRUTO.rds", compress = "gz")
```
...
# Carregando bancos de dados----
IPCA_12_19_BR <- readRDS("../coleta/data-raw/IPCARaw/IPCA_2K12_2K19_BR_BRUTO.rds")
IPCA_12_19_CIDA <- readRDS("../coleta/data-raw/IPCARaw/IPCA_2K12_2K19_CIDADE_BRUTO.rds")
IPCA_12_19_METRO <- readRDS("../coleta/data-raw/IPCARaw/IPCA_2K12_2K19_METRO_BRUTO.rds")
...
# Salvando----
write_rds(IPCA_2k12_2k19_DATA, "../coleta/data-raw/IPCARaw/IPCA_2k12_2k19_DATA_FINAL.rds", compress = "gz")
...
write_rds(IPCA_20_22_BR, "../coleta/data-raw/IPCARaw/IPCA_2K20_2K22_BR_BRUTO.rds", compress = "gz")
```
...
write_rds(IPCA_20_22_CIDA,"../coleta/data-raw/IPCARaw/IPCA_2K20_2K22_CIDADE_BRUTO.rds", compress = "gz")
```
...
write_rds(IPCA_20_22_METRO, "../coleta/data-raw/IPCARaw/IPCA_2K20_2K22_METRO_BRUTO.rds", compress = "gz")
```
...
# Carregando bancos de dados----
IPCA_20_22_BR <- readRDS("../coleta/data-raw/IPCARaw/IPCA_2K20_2K22_BR_BRUTO.rds")
IPCA_20_22_CIDA <- readRDS("../coleta/data-raw/IPCARaw/IPCA_2K20_2K22_CIDADE_BRUTO.rds")
IPCA_20_22_METRO <- readRDS("../coleta/data-raw/IPCARaw/IPCA_2K20_2K22_METRO_BRUTO.rds")
...
# Salvando----
write_rds(IPCA_2k20_2k22_DATA, "../coleta/data-raw/IPCARaw/IPCA_2k20_2k22_DATA_FINAL.rds", compress = "gz")
...
PERIOD1 <- PERIOD_GEN(2023,2024,1)
```

### Coleta de dados - Brasil

```{r}
IPCA_23_24_BR <- COLETA(PERIOD1, 7060, V = c(63, 69, 66), GE = c("Brazil"))
write_rds(IPCA_23_24_BR, "../coleta/data-raw/IPCARaw/IPCA_2K23_2K24_BR_BRUTO.rds", compress = "gz")
```

### Coleta de dados - Cidades

```{r ### Coleta de dados - Cidades - 2023}
IPCA_23_24_CIDA <- COLETA(PERIOD1, 7060, V = c(63, 69, 66), GE = c("City"))
write_rds(IPCA_23_24_CIDA,"../coleta/data-raw/IPCARaw/IPCA_2K23_2K24_CIDADE_BRUTO.rds", compress = "gz")
```

### Coleta de dados - Região metropolitana

```{r ### Coleta de dados - Região metropolitana - 2023}
IPCA_23_24_METRO <- COLETA(PERIOD1, 7060, V = c(63, 69, 66), GE = c("MetroRegion"))
write_rds(IPCA_23_24_METRO, "../coleta/data-raw/IPCARaw/IPCA_2K23_2K24_METRO_BRUTO.rds", compress = "gz")
```
...
```{r Bind final estratos geográficos SAVE - 2020-2022}
# Carregando bancos de dados----
IPCA_23_24_BR <- readRDS("../coleta/data-raw/IPCARaw/IPCA_2K23_2K24_BR_BRUTO.rds")
IPCA_23_24_CIDA <- readRDS("../coleta/data-raw/IPCARaw/IPCA_2K23_2K24_CIDADE_BRUTO.rds")
IPCA_23_24_METRO <- readRDS("../coleta/data-raw/IPCARaw/IPCA_2K23_2K24_METRO_BRUTO.rds")

#Alterando nomenclatura das variáveis----
datas <- c("IPCA_23_24_BR", "IPCA_23_24_CIDA", "IPCA_23_24_METRO")
...
# Juntando----
IPCA_23_24 <- bind_rows(IPCA_23_24_BR, IPCA_23_24_CIDA, IPCA_23_24_METRO)

#Separando colunas com mais de uma informação.
IPCA_2k23_2k24_DATA <- IPCA_23_24 |>
   separate(MUN, c("NOME_GEO", "UF"), " - ") |>
   separate(DATA_RAW, c("MES", "ANO"), " ") |>
   separate(VAR, c("INDICE","VAR"), " - ") |>
   separate(REF, c("COD_REF", "ITEM"), "\\.", fill = "left") |>
...
# Salvando----
write_rds(IPCA_2k23_2k24_DATA, "../coleta/data-raw/IPCARaw/IPCA_2k23_2k24_DATA_FINAL.rds", compress = "gz")

rm(IPCA_23_24_BR, IPCA_23_24_CIDA, IPCA_23_24_METRO, datas, df)
```
...
#Carregando bases de dados----
IPCA_1k99_2k06_DATA <- readRDS("../coleta/data-raw/IPCARaw/IPCA_1k99_2k06_DATA_FINAL.rds")
IPCA_2k6_2k11_DATA <- readRDS("../coleta/data-raw/IPCARaw/IPCA_2k6_2k11_DATA_FINAL.rds")
IPCA_2k12_2k19_DATA <- readRDS("../coleta/data-raw/IPCARaw/IPCA_2k12_2k19_DATA_FINAL.rds")
IPCA_2k20_2k22_DATA <- readRDS("../coleta/data-raw/IPCARaw/IPCA_2k20_2k22_DATA_FINAL.rds")
IPCA_2k23_2k24_DATA <- readRDS("../coleta/data-raw/IPCARaw/IPCA_2k23_2k24_DATA_FINAL.rds")

#Juntando----
IPCA_1K99_2K24_DATA_LAST <- bind_rows(IPCA_1k99_2k06_DATA,
                                      IPCA_2k6_2k11_DATA,
                                      IPCA_2k12_2k19_DATA,
                                      IPCA_2k20_2k22_DATA,
                                      IPCA_2k23_2k24_DATA)
...
REP_TEST <- distinct(IPCA_1K99_2K24_DATA_LAST)
rm(REP_TEST)

# Salvando banco de dados----
write_rds(IPCA_1K99_2K24_DATA_LAST, "../coleta/data-raw/IPCARaw/IPCA_1K99_2K24_DATA_LAST.rds", compress = "gz")

rm(PERIOD1, PERIOD_GEN, COLETA, DICIO_655, DICIO_656, DICIO_657, DICIO_7060, DICIO_2938, DICIO_1419, IPCA_1k99_2k06_DATA, IPCA_2k12_2k19_DATA, IPCA_2k20_2k22_DATA, IPCA_2k6_2k11_DATA, IPCA_2k23_2k24_DATA, IPCA_23_24, REP_TEST)
```

`REP_TEST` possui mesmo número de linhas que o `IPCA_1K99_2K24_DATA_LAST`, logo, não há entradas repetidas.  
...
DICIO_1999_2023_ALIM_F <- readRDS("../indexadores/IPCADicio/DICIO_1999_2023_IPCA_ALIM_F.rds")

# Carregando base de dados `IPCA_1K99_2K23_DATA_LAST`----
IPCA_1K99_2K24_DATA_LAST <- read_rds("../coleta/data-raw/IPCARaw/IPCA_1K99_2K24_DATA_LAST.rds")
```
...
IPCA_1K99_2K24_DATA_LAST_H_1 <- IPCA_1K99_2K24_DATA_LAST |>
   separate(COD_REF, into = c("COD_SUB_GRUPO", "COD_SUB_GRUPO_ITEM"),
            sep = 4, remove = FALSE)

IPCA_1K99_2K24_DATA_LAST_H_2 <- 
   left_join(
      IPCA_1K99_2K24_DATA_LAST_H_1,
      DICIO_1999_2023_ALIM_F,
      by = c("COD_REF","ITEM","COD_SUB_GRUPO")
   )

IPCA_1K99_2K24_DATA_LAST_H_3 <- IPCA_1K99_2K24_DATA_LAST_H_2|>
...
IPCA_1K99_2K24_DATA_LAST_H_4 <- left_join(IPCA_1K99_2K24_DATA_LAST_H_3,
                                          MESES, 
                                          by = c("MES" = "MES_PT"))

IPCA_1K99_2K24_DATA_LAST_H_5 <- IPCA_1K99_2K24_DATA_LAST_H_4 |>
...
as_date("2023-12-31")< DATE & DATE < as_date("2025-01-01")~"2024",
...
DICIO_POF <- data.frame(
  PERIODO = c("Ago 1999 - Jun 2006", "Jul 2006 - Dez 2011",
              "Jan 2012 - Dez 2019", "Jan 2020 - 2024"),
  POF = c("POF 1995-1996", "POF 2002-2003", "POF 2008-2009", "POF 2017-2018"))


IPCA_1K99_2K24_DATA_LAST_H_6 <- 
   full_join(IPCA_1K99_2K24_DATA_LAST_H_5, DICIO_POF, by = "PERIODO")
  

# Organização final----
IPCA_1K99_2K24_DATA_FINAL_H <- IPCA_1K99_2K24_DATA_LAST_H_6 |>
...
write_rds(IPCA_1K99_2K24_DATA_FINAL_H_1, "../coleta/data-raw/IPCARaw/IPCA_1K99_2K24_DATA_FINAL_H_1.rds", compress = "gz")

rm(IPCA_1K99_2K24_DATA_LAST,IPCA_1K99_2K24_DATA_LAST_H_1,IPCA_1K99_2K24_DATA_LAST_H_2,IPCA_1K99_2K24_DATA_LAST_H_3,IPCA_1K99_2K24_DATA_LAST_H_4,IPCA_1K99_2K24_DATA_LAST_H_5,IPCA_1K99_2K24_DATA_LAST_H_6,IPCA_1K99_2K24_DATA_FINAL_H,DICIO_POF,MESES, DICIO_1999_2023_ALIM_F,verif)
```

## Adicionando estruturas de ponderação POF

Ponderações processadas em `../indexadores/IPCADicio/IPCAPonderacao`.  

```{r}
# Carregando dicionário ponderações----
POND_96_19_FINAL <- read_rds("../indexadores/IPCADicio/POND_96_19_FINAL.rds")

# Carregando base de dados IPCA
IPCA_1K99_2K24_DATA_FINAL_H_1 <- read_rds("../coleta/data-raw/IPCARaw/IPCA_1K99_2K24_DATA_FINAL_H_1.rds")
```

```{r}
# Juntando IPCA com ponderação----
IPCA_1K99_2K24_DATA_FINAL_H_2 <- full_join(IPCA_1K99_2K24_DATA_FINAL_H_1, POND_96_19_FINAL, by = c("NOME_GEO","PERIODO", "POF", "COD_REF", "ITEM"))

# Verificando NA----
verif <- IPCA_1K99_2K24_DATA_FINAL_H_2 |> 
   filter(is.na(IPCA_1K99_2K24_DATA_FINAL_H_2$VAL_POND))
...
write_rds(IPCA_1K99_2K23_DATA_FINAL_H_5, "../coleta/data-raw/IPCARaw/IPCA_1K99_2K23_DATA_FINAL_H_5.rds", compress = "gz")
...
```{r}
#Carregando bancos de dados
DICIO_CADEIA_PROC <- read_excel("../indexadores/IPCADicio/DICIO_CADEIA_PROC.xlsx")

IPCA_1K99_2K24_DATA_FINAL_H_5 <- read_rds("../coleta/data-raw/IPCARaw/IPCA_1K99_2K24_DATA_FINAL_H_5.rds")

# Juntando----
IPCA_1K99_2K24_DATA_FINAL_H_6 <- 
   full_join(IPCA_1K99_2K24_DATA_FINAL_H_5, DICIO_CADEIA_PROC,
             by=c("COD_REF","COD_SUB_GRUPO","ITEM"))

# Organizando dados finais
IPCA_1K99_2K24_DATA_FINAL <- IPCA_1K99_2K24_DATA_FINAL_H_6 |> 
...
rm(IPCA_1K99_2K24_DATA_FINAL_H_5, IPCA_1K99_2K24_DATA_FINAL_H_6, DICIO_CADEIA_PROC)
```

### Salvando banco de dados com cadeia e nível proc.

```{r}
write_rds(IPCA_1K99_2K24_DATA_FINAL, "../IPCA_1K99_2K24_DATA_FINAL.rds", compress = "gz")
```
